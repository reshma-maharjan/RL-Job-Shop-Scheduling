...
def train_func():
    ...
    wandb.init(project ='JSS_A2C_server_3gpu', config=default_config, name="ta47")
    ray.init(num_gpus=2)  # Initialize Ray with 2 GPUs
