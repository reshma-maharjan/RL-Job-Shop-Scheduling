...
def train_func():
    ...
    default_config = {
        ...
        # APEX-DQN specific configurations
    ...
    # Initialize W&B
    wandb.init(project='JSS_APEX_DQN_server', config=default_config, name="ta01")
    ray.init()
    ...
    # Stop criteria
    stop = {
        "time_total_s": 3 * 60,  # The training loop runs for a total time of 10 minutes
    }
